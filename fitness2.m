function TEM=fitness2(val) %%长度 
var = [0.67155e-7 0.0064 5];

l1=0.0006;
l2=val/1000;   %二层厚度待定(单位转化为米)
l3=0.0036;
l4=0.0055;  %四层厚度为5.5mm
l5=var(2);
...
Temp=[];
sum=0;
sprintf( 'The surface temperature at 3300s is %d',T((3300+var(3))*rt,xsec(5)) )
sprintf( 'The surface temperature at 3600s is %d',T((3600+var(3))*rt,xsec(5)) )
